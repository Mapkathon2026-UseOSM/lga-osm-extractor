...
Drop the generated preview screenshot or GIF here as `preview.png` (or
`preview.gif`), then uncomment the image line near the top of the main
README to have it render on GitHub.
